package se2.project.antimonopoly.websocketserver;
...
import se2.project.antimonopoly.websocketserver.websocket.StompFrameHandlerClientImpl;
...
/**
 * Integration test for the WebSocket broker.
 */
...
public class WebSocketBrokerIntegrationTest {
    ...
    private final String WEBSOCKET_URI = "ws://localhost:%d/ws";
